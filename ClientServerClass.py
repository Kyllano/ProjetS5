...
class Client :
    ...
    def connect(self) :
        ...
        try :
            ...
            return -2
        if (self.port == None or not ClientServerClassUtils.checkValidIpAddress(self.addr)) :
...
class Server :
    ...
    def start(self) :
        if (not ClientServerClassUtils.checkValidPort(self.port)) :
        ...
        if (self.sock == None) :
            ...
            try:
                ...
                print("[SERVEUR] Erreur de bind du socket: " + str(msg))
                return -3

        print("En attente de connexion d'un client")
